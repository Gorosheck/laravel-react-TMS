...
Route::get('/', [MainController::class, 'index'])
    ->middleware(\App\Http\Middleware\CookieBanner::class)
    ->name('main');


Route::get('/today', [MainController::class, 'todayArticles'])->name('today');
...
Route::group(['prefix' => '/articles', 'as' => 'article.', 'middleware' => 'auth'], function () {
    ...
    Route::get('/create', [ArticleController::class, 'createForm'])->name('create.form')->middleware(
        'can:create,' . Article::class);

    Route::post('/create', [ArticleController::class, 'create'])->name('create')->middleware(
        'can:create,' . Article::class);

    Route::group(['prefix' => '/{article}/edit', 'middleware' => 'can:edit,article'], function () {
        Route::get('', [ArticleController::class, 'editForm'])->name('edit.form');

        Route::post('', [ArticleController::class, 'edit'])->name('edit');
    });

    Route::get('/{article}', [ArticleController::class, 'show'])->name('show');

    Route::post('/{article}/delete', [ArticleController::class, 'delete'])->name('delete');
});
